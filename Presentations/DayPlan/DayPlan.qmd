...
![](images/scope.jpg){fig-align="center"}
...
::: {.column width="80%"}
**Dr Lauren Cator** - *One Health Vector-Borne Diseases Hub & Imperial College London*
...
How forecasting and probabilistic programming can improve health outcomes?
:::
:::::
...
Insights from Modelling and Analytics within the NHS
:::
:::::
...
-   **Stage 1 - Break-out Discussions (45 minutes)**
    ...
    -   45 minutes to talk about key challenges in Health Policy that relate to modelling & forecasting
...
<p>From Questions to Insights</p> 
<p>**Dr. Josh Tyler**</p> 

## What is a Forecasting Contest?

## Journey of Contest
![](images/Journey.png){fig-align="center"}


## Considerations
![](images/Considerations.png){fig-align="center"}
...
-   **Stage 2 - Brainstorming requests for workshops, training and support (20 minutes)**
    -   Split into groups and make a list of different ideas that would help you make progress in your area
...
![](images/QRCode.png){height="350" fig-align="center"}
